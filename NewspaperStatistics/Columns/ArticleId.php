...
class ArticleId extends ActionDimension
{
    ...
    {
        return Piwik::translate('NewspaperStatistics_ArticleId');
    }
    ...
    protected function configureSegments()
    {
        ...
        $segment->setName('NewspaperStatistics_ArticleId');
    ...
    public function onNewAction(Request $request, Visitor $visitor, Action $action)
    {
        ...
        $value = Common::getRequestVar('article_id', false, 'string', $request->getParams());
