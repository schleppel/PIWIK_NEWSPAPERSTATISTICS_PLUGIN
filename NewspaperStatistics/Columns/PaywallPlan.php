 ...
 *
 */
namespace Piwik\Plugins\NewspaperStatistics\Columns;
...
/**
 * Class PaywallPlan
 * @package Piwik\Plugins\NewspaperStatistics\Columns
 */
class PaywallPlan extends VisitDimension
{
    ...
    {
        return Piwik::translate('NewspaperStatistics_PaywallPlan');
    }
    ...
    protected function configureSegments()
    {
        ...
        $segment->setName('NewspaperStatistics_PaywallPlan');
    ...
    {
        return Common::getRequestVar('paywall_plan', $default = false, 'string', $request->getParams());
