...
use Piwik\Plugins\NewspaperStatistics\Columns\PaywallPlan;
use Piwik\View;

/**
 * Class GetPaywallPlan
 * @package Piwik\Plugins\NewspaperStatistics\Reports
 */
class GetPaywallPlan extends Base
{
    /** @inheritdoc */
    protected function init()
    {
        ...
        $this->name          = Piwik::translate('NewspaperStatistics_PaywallPlan');
        ...
        $this->metrics       = array('nb_visits', 'nb_uniq_visitors');
        ...
        // If a menu title is specified, the report will be displayed in the menu
         //$this->menuTitle    = Piwik::translate('NewspaperStatistics_PaywallPlan');
        ...
        // exported as a widget
         $this->widgetTitle  = Piwik::translate('NewspaperStatistics_PaywallPlan');
    }
    ...
    public function configureView(ViewDataTable $view)
    {
        ...
        if (!empty($this->dimension)) {
            $view->config->addTranslations(array('label' =>  Piwik::translate($this->dimension->getName())));
        }
    ...
    {
        $view = new View('@NewspaperStatistics/getPaywallPlan');
        $view->myData = array();
