...
use Piwik\Plugins\NewspaperStatistics\Columns\ArticleId;
use Piwik\View;
 ...
 */
class GetArticleId extends Base
{
    /** @inheritdoc */
    protected function init()
    {
        ...
        $this->name          = Piwik::translate('NewspaperStatistics_ArticleId');
        ...
        // If a menu title is specified, the report will be displayed in the menu
         //$this->menuTitle    = Piwik::translate('NewspaperStatistics_ArticleId');
        ...
        // exported as a widget
         $this->widgetTitle  = Piwik::translate('NewspaperStatistics_ArticleId');
    }
    ...
    {
        $view = new View('@NewspaperStatistics/getArticleId');
        $view->myData = array();
